...
public class DrawingForm extends javax.swing.JFrame {
    ...
    public Rectangle[] rect = new Rectangle[5];
    ...
    private int btnAddToArrayActionPerformed(java.awt.event.ActionEvent evt) 
    {
        ...
        if(cmbText.equals("Rectangle"))
        {
            ...
            rect[numOfRect] = new Rectangle(w, h);
            numOfRect++;
        ...
        if(cmbText.equals("Square"))
        {
            ...
            rect[numOfRect] = new Square(s);
            numOfRect++;
        }
        
        if(numOfRect >= 5)
        {
            JOptionPane.showMessageDialog(null, "The number of triangles cannot exceed five.");
            return 0;
        }
        return 0;
    ...
    private void btnDrawArrayActionPerformed(java.awt.event.ActionEvent evt) 
    {
        final int dis = 70;
    ...
    private void btnSortArrayActionPerformed(java.awt.event.ActionEvent evt) 
    {
       
        if(chkSortDescending.isSelected())
        {
            selectionSort(true);
        }
        else
    ...
    private void selectionSort(boolean descending)
    {
        if(radioSortWidth.isSelected())
        {
            for(int i = 0; i < rect.length - 1; i++)
            {
                ...
                for(int j = i + 1; j < rect.length; j++)
                {
                    ...
                    Rectangle temp = rect[minIndex];
                    rect[minIndex] = rect[i];
                    rect[i] = temp;
            }
        }
        ...
        if(descending)
        {
            for(int i = 0, j = rect.length - 1; j > i; i++, j--)
            {
                Rectangle r2 = rect[i];
                rect[i] = rect[j];
                rect[j] = r2;
